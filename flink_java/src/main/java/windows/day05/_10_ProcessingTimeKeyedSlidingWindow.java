 ...
 *  * 窗口触发后, 每个组的窗口 , 都会输出结果
 */
public class _10_ProcessingTimeKeyedSlidingWindow {
    public static void main(String[] args) throws Exception {
        ...
        // 按照自定义方式来调用窗口
        WindowedStream<Tuple2<String, Integer>, String, TimeWindow> windowedStream = keyedSteam.window(SlidingProcessingTimeWindows.of(Time.seconds(20), Time.seconds(10)));
